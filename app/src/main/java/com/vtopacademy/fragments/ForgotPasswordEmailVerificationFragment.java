...
import com.vtopacademy.databinding.FragmentForgotPasswordEmailVerificationBinding;
...
@AndroidEntryPoint
public class ForgotPasswordEmailVerificationFragment extends Fragment {

    private FragmentForgotPasswordEmailVerificationBinding binding;
    private AuthenticationViewModel authenticationViewModel;

    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        binding = FragmentForgotPasswordEmailVerificationBinding.inflate(inflater, container, false);
        View view = binding.getRoot();
        binding.submitButton.setOnClickListener(buttonView -> {
            authenticationViewModel.verifyForgotPasswordCode(binding.codeEditText.getText().toString());
        });
        return view;
    }
    ...
    public void onViewCreated(@NonNull View view, Bundle savedInstanceState) {
        ...
        authenticationViewModel.getForgotPasswordEmailVerificationUiState().observe(
    ...
    private void navigateToResetPasswordFragment() {
        NavDirections action = ForgotPasswordEmailVerificationFragmentDirections
                .actionForgotPasswordEmailVerificationFragmentToResetPasswordFragment();
