...
import com.vtopacademy.databinding.FragmentRegistrationEmailBinding;
...
public class RegistrationEmailFragment extends Fragment {
    ...
    private FragmentRegistrationEmailBinding binding;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        binding.submitButton.setOnClickListener(buttonView -> {
            authenticationViewModel.generateRegistrationCode(binding.emailEditText.getText().toString());
        });
        return view;
    }
    ...
    public void onViewCreated(@NonNull View view, Bundle savedInstanceState) {
        ...
        authenticationViewModel.getRegistrationEmailUiState().observe(
    ...
    private void updateUI(AuthenticationUiState result) {
        switch (result.getAuthenticationUiStatus()) {
            ...
            case Success:
                hideLoadingUi();
                navigateToRegistrationEmailVerificationFragment();
                break;
        }
    }

    private void navigateToRegistrationEmailVerificationFragment() {
        NavDirections action = RegistrationEmailFragmentDirections
                .actionRegistrationEmailFragmentToRegistrationEmailVerificationFragment();
